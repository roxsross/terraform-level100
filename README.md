# Laboratorios Terraform nivel Fundamental [100] by RoxsRoss
...
1. Crear un sitio web estático alojado en un (bucket) de Amazon S3 utilizando Terraform [enlace](./lab-002/README.md)

2. Creación de una tabla DynamoDB e inserción de elementos en ella utilizando Terraform [enlace](./lab-002/README.md)

3. Creación y prueba de una base de datos Amazon RDS MySQL utilizando Terraform. [enlace](./lab-003/README.md)

4. Creación de una Virtual Private Cloud (VPC) de dos niveles utilizando Terraform. [enlace](./lab-004/README.md)
